...
def generate_tts(text):
    ...
    try:
        ...
        if audio_data[0:4] != b"RIFF":
            ...
            print(
                "TTS ERROR: response is NOT RIFF/WAV"
            )
