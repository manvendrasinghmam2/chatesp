...
def generate_tts(text):
    ...
    # Groq Orpheus input max = 200 chars
...
def upload_audio():
    ...
    try:
        ...
        if (
            ...
            print("WARNING: WAV header invalid")
        ...
        # Improve recognition for ESP32 microphone
        ...
        if (
            ...
            # IMPORTANT:
            # Return 200 so ESP32 does not treat this as
